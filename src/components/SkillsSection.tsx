      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold tracking-tight mb-3">
            My Technical <span className="bg-grad-primary bg-clip-text text-transparent">Stack</span>
          </h2>
          <p className="text-slate-400 text-base max-w-xl">
            Technologies and tools I use to build robust, high-performance cross-platform applications.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {category.skills.map((skill, skillIndex) => (
                  <motion.div
                    ...
                    className="glass-card rounded-2xl p-4 flex items-center gap-4 relative overflow-hidden group hover:border-brand-purple/40 hover:-translate-y-1 transition-all"
                  >
                    {/* Skill Icon */}
